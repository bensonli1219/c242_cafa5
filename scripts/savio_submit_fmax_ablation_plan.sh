#!/bin/bash
# Submit the staged 5-epoch Fmax ablation plan on Savio.
#
...
TRAIN_SCRIPT="${TRAIN_SCRIPT:-$REPO_ROOT/scripts/savio_train_full_graph_tuned.sh}"
RUN_PREFIX="${RUN_PREFIX:-fmax5}"
...
case "$PLAN" in
  full)
    submit_experiment "bce_control" "CCO MFO" "128" "0.2" "0.001" "0.0001" "bce" "1.0" ""
    submit_experiment "capacity256_bce" "CCO MFO" "256" "0.2" "0.001" "0.0001" "bce" "1.0" ""
    submit_experiment "weighted_mild" "CCO MFO" "128" "0.2" "0.001" "0.0001" "weighted_bce" "0.25" "5"
    submit_experiment "capacity256_regularized_bce" "CCO MFO" "256" "0.3" "0.001" "0.0005" "bce" "1.0" ""
    ;;
  report)
    submit_experiment "bce_control" "CCO MFO" "128" "0.2" "0.001" "0.0001" "bce" "1.0" ""
    submit_experiment "weighted_mild" "CCO MFO" "128" "0.2" "0.001" "0.0001" "weighted_bce" "0.25" "5"
    ...
    ;;
  *)
    echo "PLAN must be 'full' or 'report': $PLAN" >&2
    exit 2
    ;;
esac
