#!/bin/bash
#SBATCH --job-name=cafa5_debug_train
...
#SBATCH --output=/global/scratch/users/%u/logs/cafa5_debug_train_%j.out
#SBATCH --error=/global/scratch/users/%u/logs/cafa5_debug_train_%j.err
...
DEBUG_ROOT="${DEBUG_ROOT:-$RUN_ROOT/debug_import_train/${SLURM_JOB_ID:-local_$(date +%Y%m%d_%H%M%S)}}"
